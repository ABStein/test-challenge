...
describe 'Testing a Facebook API' do
  ...
  it 'should hit the api with the access_token field misspelled' do
    facebook_api_key = ENV["FACEBOOK_ACCESS_TOKEN"]
    get "https://graph.facebook.com/v5.0/me?fields=id%2Cfirst_na%2Clast_name&accs_token=#{facebook_api_key}"
